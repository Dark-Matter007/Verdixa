...
export default function AdminDashboard() {
  ...
  return <div className="dashboard-layout vx-admin-shell"><Sidebar/><main className="dashboard-main vx-admin-main">
    <header className="vx-admin-head"><div><p className="vx-eyebrow">Control room / overview</p><h1>Platform operations</h1><p>Content integrity, user activity, and judge outcomes from persisted platform data.</p></div><button className="primary-button" onClick={() => navigate("/admin/problems/new")}><Plus size={16}/> New problem</button></header>
